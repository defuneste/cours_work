# Date: March 2022
# Olivier Leroy
# Homework week 9 Statictical Rethinking
# https://github.com/rmcelreath/stat_rethinking_2022/blob/main/homework/week09.pdf
# I Just reproduced/cc solutions !
# 2-3 exercices was outside of what I can do now
# I will take any certificat/meme that I can put on linkedin
# and use it to advertise this great course!
# leroy.oli@gmail.com
...
# H (hunter) ---> D
# H ----> S
# the data set also contains month and year that could be used in this DAG

# I would have go with just a linear model and be wrong
...
precis(m1a)
# postif bA, older better you bring back stuff ?

Ar <- round( d$age / 10 ) * 10 # just for representation but could have been good to use category for age
...
# huge variation when youg and old, I could have go with 2nd polynomial here
                                        #
                                        # Richard used an equation that I will not have used
# equation with two parameters beta1 and beta2
# try something else
# normalize age
dat$A2 <- d$age / 80 # still need to understand when to standardize/centered
...
#
# usings PSIS was intersting!
                                        # 2
# now we are adding H ass varying effect

dat$H <- as.integer(as.factor(d$id))
dat$NH <- max(dat$H)

check_index(dat$H) # where this functions come from it is nice !

# the rest is out of my leagues now ...
...
## c'est impressionnant de puissance !
